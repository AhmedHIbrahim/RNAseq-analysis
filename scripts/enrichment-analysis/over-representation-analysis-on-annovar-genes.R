...
geneList <-scan('annovars-genes.txt', character(), quote = "")
...
write.csv(keggDf, "annovar-based-ora-kegg-p-0.01.csv")
...
ImmunSigEnrichC7 <- enricher(gene.df$ENTREZID,     # a vector of gene id
                             ...
                             pvalueCutoff = 0.1)  # adjusted pvalue cutoff on enrichment tests to report
